# SFC Wave Compiler — Pass log archive

Per-pass history extracted from STATUS.md at M2.8 (consultant
#20). Active STATUS.md tracks the current milestone + last pass +
current baselines only; this file holds the M0–M2 pass log so
